package blocoinicializacaoestatico.dominio;
...
public class Anime {
    ...
    // Lembrando que bloco de inicialização estatico são executados apenas uma vez.
    static {
    ...
    /*
        ...
        0 - Bloco de inicialização é carregado e executado quando a JVM carregar a classe.
